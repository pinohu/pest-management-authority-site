<?php
/**
 * Working wp-config.php for pestmanagementscience.com
...
define('DB_HOST', 'sdb-t.hosting.stackcp.net');  // Confirmed working
 ...
 * Enable for troubleshooting, disable for production
 */
...
define('WP_HOME','http://pestmanagementscience.com');  // Start with HTTP, can change to HTTPS later
define('WP_SITEURL','http://pestmanagementscience.com');
