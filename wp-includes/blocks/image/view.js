...
/******/
/************************************************************************/
var __webpack_exports__ = {}; // external "@wordpress/interactivity"
...
const interactivity_namespaceObject = x({
  ...
  ["withSyncEvent"]: () =>
    __WEBPACK_EXTERNAL_MODULE__wordpress_interactivity_8e89b257__.withSyncEvent,
...
const { state, actions, callbacks } = (0, interactivity_namespaceObject.store)(
  "core/image",
  {
    ...
    actions: {
      ...
      handleKeydown: (0, interactivity_namespaceObject.withSyncEvent)(
        (event) => {
          if (state.overlayEnabled) {
      ...
      handleTouchMove: (0, interactivity_namespaceObject.withSyncEvent)(
        (event) => {
