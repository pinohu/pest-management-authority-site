var runtime = ((t) => {
    ...
    return (
      o(r, "_invoke", {
        value:
          ...
          (h = s),
          function (t, r) {
            if (h === y) throw new Error("Generator is already running");
            if (h === g) {
              if ("throw" === t) throw r;
            ...
            for (u.method = t, u.arg = r; ; ) {
                ...
                ((n = (function t(r, n) {
                  ...
                  return i === e
                    ? ((n.delegate = null),
                      ...
                      v)
                    : "throw" === (o = f(i, r.iterator, n.arg)).type
                      ? ((n.method = "throw"),
                        (n.arg = o.arg),
                        (n.delegate = null),
                        v)
              ...
              if ("next" === u.method) u.sent = u._sent = u.arg;
                ...
                if (h === s) throw ((h = g), u.arg);
                u.dispatchException(u.arg);
              } else "return" === u.method && u.abrupt("return", u.arg);
              if (((h = y), "normal" === (n = f(a, c, u)).type)) {
                if (((h = u.done ? g : p), n.arg !== v))
                  return { value: n.arg, done: u.done };
              } else
                "throw" === n.type &&
                  ((h = g), (u.method = "throw"), (u.arg = n.arg));
            }
          }),
      }),
      r
  ...
  var b = Object.getPrototypeOf,
    L =
      ((b = b && b(b(k([])))) && b !== r && n.call(b, a) && (i = b),
      (w.prototype = d.prototype = Object.create(i)));
  function x(t) {
  ...
  return (
    o(L, "constructor", { value: (m.prototype = w), configurable: !0 }),
