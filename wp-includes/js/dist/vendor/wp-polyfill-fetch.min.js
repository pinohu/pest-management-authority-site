((t, e) => {
    ...
    return (
              ...
              : i && Blob.prototype.isPrototypeOf(t)
                ...
                : a && FormData.prototype.isPrototypeOf(t)
                  ...
                  : n && URLSearchParams.prototype.isPrototypeOf(t)
                    ...
                    : h && i && (e = t) && DataView.prototype.isPrototypeOf(e)
      ...
      (this.text = function () {
        ...
        if (this._bodyBlob)
          return (
            (o = this._bodyBlob),
            (e = l((t = new FileReader()))),
            (r = (r = /charset=([A-Za-z0-9_-]+)/.exec(o.type))
              ? r[1]
              : "utf-8"),
            t.readAsText(o, r),
            e
  ...
  h &&
    ...
    s && (c.prototype[Symbol.iterator] = c.prototype.entries);
  var w = [
    "CONNECT",
    "DELETE",
    "GET",
    ...
    return new Promise(function (n, s) {
      ...
      (y.onload = function () {
        ...
        "include" === a.credentials
          ? (y.withCredentials = !0)
          : "omit" === a.credentials && (y.withCredentials = !1),
        "responseType" in y &&
          (i
            ? (y.responseType = "blob")
            : h && (y.responseType = "arraybuffer")),
        r &&
        "object" == typeof r.headers &&
        !(
          r.headers instanceof c ||
          (o.Headers && r.headers instanceof o.Headers)
        )
          ? ((d = []),
        ...
        a.signal &&
          ...
          (y.onreadystatechange = function () {
            4 === y.readyState && a.signal.removeEventListener("abort", l);
          })),
  ...
  (_.polyfill = !0),
    o.fetch ||
      ((o.fetch = _), (o.Headers = c), (o.Request = E), (o.Response = g)),
    (t.Headers = c),
    (t.Request = E),
    (t.Response = g),
    (t.fetch = _),
