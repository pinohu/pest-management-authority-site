...
(() => {
  ...
  const r = (function (t, e) {
    ...
    function o() {
      ...
      for (o = new Array(a), c = 0; c < a; c++) o[c] = arguments[c];
      return (
        (i = { args: o, val: t.apply(null, o) }),
        n ? ((n.prev = i), (i.next = n)) : (r = i),
  ...
  function s(t) {
    ...
    return (
      ...
      new o({ tag: t[2], attrs: t[3], type: e, content: t[5] })
    );
  }
  const o = Object.assign(
    function (t) {
      ...
      if (
        (Object.assign(this, { tag: e, type: s, content: o }),
      ...
      "string" == typeof n
        ? (this.attrs = r(n))
        : n.length === c.length && c.every((t, e) => t === n[e])
          ? (this.attrs = n)
    ...
    },
    {
      next: function t(e, r, o = 0) {
        ...
        const i = c.exec(r);
        if (!i) return;
        if ("[" === i[1] && "]" === i[7]) return t(e, r, c.lastIndex);
        const a = { index: i.index, content: i[0], shortcode: s(i) };
        return (
          i[1] && ((a.content = a.content.slice(1)), a.index++),
