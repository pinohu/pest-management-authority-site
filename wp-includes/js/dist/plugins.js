/******/ (() => {
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","hooks"]
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // external ["wp","isShallowEqual"]
  ...
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","deprecated"]
  const external_wp_deprecated_namespaceObject = window["wp"]["deprecated"];
  var external_wp_deprecated_default = /*#__PURE__*/ __webpack_require__.n(
    external_wp_deprecated_namespaceObject,
  ); // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/plugins/build-module/components/plugin-context/index.js
  /**
  ...
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // ./node_modules/@wordpress/icons/build-module/library/plugins.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_plugins = plugins; // ./node_modules/@wordpress/plugins/build-module/api/index.js
  ...
  /* harmony default export */ const plugin_area = PluginArea; // ./node_modules/@wordpress/plugins/build-module/components/index.js
