/******/ (() => {
  ...
  const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/@wordpress/patterns/build-module/store/reducer.js
  /**
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // ./node_modules/@wordpress/patterns/build-module/constants.js
  const PATTERN_TYPES = {
    theme: "pattern",
    user: "wp_block",
  };
  ...
  const PATTERN_OVERRIDES_BINDING_SOURCE = "core/pattern-overrides"; // ./node_modules/@wordpress/patterns/build-module/store/actions.js
   ...
   * Module Constants
   */
  const STORE_NAME = "core/patterns"; // ./node_modules/@wordpress/patterns/build-module/store/selectors.js
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/patterns/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
  ...
  unlock(store).registerPrivateSelectors(selectors_namespaceObject); // external ["wp","components"]
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/@wordpress/patterns/build-module/api/index.js
  /**
   * Internal dependencies
   */
  ...
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/patterns/build-module/components/overrides-panel.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // ./node_modules/@wordpress/patterns/build-module/components/category-selector.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // ./node_modules/@wordpress/icons/build-module/library/symbol.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_symbol = symbol; // ./node_modules/@wordpress/patterns/build-module/components/pattern-convert-button.js
    ...
    const canConvert = (0, external_wp_data_namespaceObject.useSelect)(
      (select) => {
        ...
        const hasReusableBlockSupport = (blockName) => {
          const blockType = (0,
          external_wp_blocks_namespaceObject.getBlockType)(blockName);
  ...
  const external_wp_url_namespaceObject = window["wp"]["url"]; // ./node_modules/@wordpress/patterns/build-module/components/patterns-manage-button.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const patterns_manage_button =
    PatternsManageButton; // ./node_modules/@wordpress/patterns/build-module/components/index.js
  ...
  const external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // ./node_modules/@wordpress/patterns/build-module/components/rename-pattern-category-modal.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const pattern_overrides_controls =
    PatternOverridesControls; // ./node_modules/@wordpress/patterns/build-module/components/reset-overrides-control.js
  ...
  /* harmony default export */ const library_copy = copy; // ./node_modules/@wordpress/patterns/build-module/components/pattern-overrides-block-controls.js
