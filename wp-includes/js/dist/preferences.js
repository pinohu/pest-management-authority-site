/******/ (() => {
  ...
  const external_wp_data_namespaceObject = window["wp"]["data"]; // external ["wp","components"]
  ...
  /* harmony default export */ const library_check = check; // external ["wp","a11y"]

  const external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // ./node_modules/@wordpress/preferences/build-module/store/reducer.js
  /**
   * WordPress dependencies
   */
   ...
   * @type {string}
   */
  const STORE_NAME = "core/preferences"; // ./node_modules/@wordpress/preferences/build-module/store/index.js
  ...
  (0, external_wp_data_namespaceObject.register)(store); // ./node_modules/@wordpress/preferences/build-module/components/preference-toggle-menu-item/index.js
  ...
  /* harmony default export */ const preference_base_option = BaseOption; // ./node_modules/@wordpress/preferences/build-module/components/preference-toggle-control/index.js
  ...
  /* harmony default export */ const preference_toggle_control =
    PreferenceToggleControl; // ./node_modules/@wordpress/preferences/build-module/components/preferences-modal/index.js
  ...
  /* harmony default export */ const preferences_modal_section = Section; // external ["wp","compose"]

  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // ./node_modules/@wordpress/icons/build-module/icon/index.js
  /**
   * WordPress dependencies
   */
  ...
  external_wp_element_namespaceObject.forwardRef)(Icon); // ./node_modules/@wordpress/icons/build-module/library/chevron-left.js
  ...
  /* harmony default export */ const chevron_left = chevronLeft; // ./node_modules/@wordpress/icons/build-module/library/chevron-right.js
  ...
  /* harmony default export */ const chevron_right = chevronRight; // external ["wp","privateApis"]

  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/preferences/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
