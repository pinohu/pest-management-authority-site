/******/ (() => {
  ...
  const external_wp_commands_namespaceObject = window["wp"]["commands"]; // external ["wp","i18n"]
  ...
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/plus.js
  /**
  ...
  /* harmony default export */ const library_plus = plus; // external ["wp","url"]

  const external_wp_url_namespaceObject = window["wp"]["url"]; // external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","notices"]
  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // external ["wp","router"]
  const external_wp_router_namespaceObject = window["wp"]["router"]; // external ["wp","privateApis"]
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/core-commands/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_post = post; // ./node_modules/@wordpress/icons/build-module/library/page.js
  ...
  /* harmony default export */ const library_page = page; // ./node_modules/@wordpress/icons/build-module/library/layout.js
  ...
  /* harmony default export */ const library_layout = layout; // ./node_modules/@wordpress/icons/build-module/library/symbol-filled.js
  ...
  /* harmony default export */ const symbol_filled = symbolFilled; // ./node_modules/@wordpress/icons/build-module/library/navigation.js
  ...
  /* harmony default export */ const library_navigation = navigation; // ./node_modules/@wordpress/icons/build-module/library/styles.js
  ...
  /* harmony default export */ const library_styles = styles; // ./node_modules/@wordpress/icons/build-module/library/symbol.js
  ...
  /* harmony default export */ const library_symbol = symbol; // external ["wp","compose"]

  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","htmlEntities"]
  const external_wp_htmlEntities_namespaceObject = window["wp"]["htmlEntities"]; // ./node_modules/@wordpress/core-commands/build-module/utils/order-entity-records-by-search.js
