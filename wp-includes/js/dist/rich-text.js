/******/ (() => {
  ...
  const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/@wordpress/rich-text/build-module/store/reducer.js
  /**
  ...
  (0, external_wp_data_namespaceObject.register)(store); // ./node_modules/@wordpress/rich-text/build-module/is-format-equal.js
   ...
   */
  const ZWNBSP = "\ufeff"; // external ["wp","escapeHtml"]

  const external_wp_escapeHtml_namespaceObject = window["wp"]["escapeHtml"]; // ./node_modules/@wordpress/rich-text/build-module/get-active-formats.js
  /** @typedef {import('./types').RichTextValue} RichTextValue */
          ...
          replacements: [
            {
              ...
              attributes: {
                "data-rich-text-comment":
                  node.nodeType === node.COMMENT_NODE
                    ? node.nodeValue
                    : node.getAttribute("data-rich-text-comment"),
              },
            },
          ],
  ...
  function getActiveFormat(value, formatType) {
    return getActiveFormats(value).find(({ type }) => type === formatType);
  ...
  const external_wp_a11y_namespaceObject = window["wp"]["a11y"]; // external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/@wordpress/rich-text/build-module/toggle-format.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","deprecated"]
  ...
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // ./node_modules/@wordpress/rich-text/build-module/component/use-anchor.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // ./node_modules/@wordpress/rich-text/build-module/component/event-listeners/format-boundaries.js
  /**
   * WordPress dependencies
   */
  ...
  function __experimentalRichText() {} // ./node_modules/@wordpress/rich-text/build-module/index.js
