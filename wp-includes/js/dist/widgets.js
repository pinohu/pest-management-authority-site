/******/ (() => {
  ...
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/widget.js
  /**
  ...
  /* harmony default export */ const library_widget = widget; // ./node_modules/clsx/dist/clsx.mjs
  ...
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // ./node_modules/@wordpress/icons/build-module/library/brush.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_brush = brush; // external ["wp","i18n"]

  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // external ["wp","element"]
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/@wordpress/widgets/build-module/blocks/legacy-widget/edit/widget-type-selector.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","apiFetch"]
  ...
  /* harmony default export */ const legacy_widget_transforms = transforms; // ./node_modules/@wordpress/widgets/build-module/blocks/legacy-widget/index.js
  ...
  /* harmony default export */ const library_group = group; // ./node_modules/@wordpress/widgets/build-module/blocks/widget-group/edit.js
  ...
  /* harmony default export */ const deprecated = [v1]; // ./node_modules/@wordpress/widgets/build-module/blocks/widget-group/index.js
  ...
  /* harmony default export */ const move_to = moveTo; // ./node_modules/@wordpress/widgets/build-module/components/move-to-widget-area/index.js
