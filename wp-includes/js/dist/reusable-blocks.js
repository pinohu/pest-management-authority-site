/******/ (() => {
  ...
  const external_wp_data_namespaceObject = window["wp"]["data"]; // external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // external ["wp","blocks"]
  const external_wp_blocks_namespaceObject = window["wp"]["blocks"]; // external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/@wordpress/reusable-blocks/build-module/store/actions.js
  /**
  ...
  (0, external_wp_data_namespaceObject.register)(store); // external ["wp","element"]

  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","components"]
  ...
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/symbol.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_symbol = symbol; // external ["wp","notices"]

  const external_wp_notices_namespaceObject = window["wp"]["notices"]; // external ["wp","coreData"]
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // ./node_modules/@wordpress/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-block-convert-button.js
  /**
   * WordPress dependencies
   */
  ...
  const external_wp_url_namespaceObject = window["wp"]["url"]; // ./node_modules/@wordpress/reusable-blocks/build-module/components/reusable-blocks-menu-items/reusable-blocks-manage-button.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const reusable_blocks_manage_button =
    ReusableBlocksManageButton; // ./node_modules/@wordpress/reusable-blocks/build-module/components/reusable-blocks-menu-items/index.js
