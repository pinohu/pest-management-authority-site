/******/ (() => {
  ...
  const external_wp_blockLibrary_namespaceObject = window["wp"]["blockLibrary"]; // external ["wp","widgets"]
  const external_wp_widgets_namespaceObject = window["wp"]["widgets"]; // external ["wp","blocks"]
  ...
  const external_wp_preferences_namespaceObject = window["wp"]["preferences"]; // external ["wp","components"]
  const external_wp_components_namespaceObject = window["wp"]["components"]; // external ["wp","i18n"]
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // external ["wp","blockEditor"]
  const external_wp_blockEditor_namespaceObject = window["wp"]["blockEditor"]; // external ["wp","compose"]
  const external_wp_compose_namespaceObject = window["wp"]["compose"]; // external ["wp","hooks"]
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/customize-widgets/build-module/components/error-boundary/index.js
  /**
  ...
  const external_wp_coreData_namespaceObject = window["wp"]["coreData"]; // external ["wp","mediaUtils"]
  const external_wp_mediaUtils_namespaceObject = window["wp"]["mediaUtils"]; // ./node_modules/@wordpress/customize-widgets/build-module/components/block-inspector-button/index.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const block_inspector_button =
    BlockInspectorButton; // ./node_modules/clsx/dist/clsx.mjs
  ...
  /* harmony default export */ const dist_clsx = clsx; // external ["wp","keycodes"]
  const external_wp_keycodes_namespaceObject = window["wp"]["keycodes"]; // external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // ./node_modules/@wordpress/icons/build-module/library/undo.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_redo = redo; // ./node_modules/@wordpress/icons/build-module/library/plus.js
  ...
  /* harmony default export */ const library_plus = plus; // ./node_modules/@wordpress/icons/build-module/library/close-small.js
  ...
  /* harmony default export */ const close_small = closeSmall; // ./node_modules/@wordpress/customize-widgets/build-module/store/reducer.js
   ...
   * Module Constants
   */
  const STORE_NAME = "core/customize-widgets"; // ./node_modules/@wordpress/customize-widgets/build-module/store/index.js
  ...
  (0, external_wp_data_namespaceObject.register)(store); // ./node_modules/@wordpress/customize-widgets/build-module/components/inserter/index.js
  ...
  /* harmony default export */ const components_inserter = Inserter; // ./node_modules/@wordpress/icons/build-module/library/more-vertical.js
  ...
  /* harmony default export */ const library_external = external; // external ["wp","keyboardShortcuts"]

  const external_wp_keyboardShortcuts_namespaceObject =
    window["wp"]["keyboardShortcuts"]; // ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/config.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const keyboard_shortcut_help_modal_shortcut =
    Shortcut; // ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/dynamic-shortcut.js
  ...
  /* harmony default export */ const dynamic_shortcut = DynamicShortcut; // ./node_modules/@wordpress/customize-widgets/build-module/components/keyboard-shortcut-help-modal/index.js
  ...
  /* harmony default export */ const header = Header; // ./node_modules/@wordpress/customize-widgets/build-module/components/inserter/use-inserter.js
  ...
  var es6_default = /*#__PURE__*/ __webpack_require__.n(es6); // external ["wp","isShallowEqual"]
  ...
  const useFocusControl = () =>
    (0, external_wp_element_namespaceObject.useContext)(FocusControlContext); // ./node_modules/@wordpress/customize-widgets/build-module/components/focus-control/use-blocks-focus-control.js
  ...
  const external_wp_privateApis_namespaceObject = window["wp"]["privateApis"]; // ./node_modules/@wordpress/customize-widgets/build-module/lock-unlock.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const keyboard_shortcuts = KeyboardShortcuts; // ./node_modules/@wordpress/customize-widgets/build-module/components/block-appender/index.js
  ...
  const external_wp_dom_namespaceObject = window["wp"]["dom"]; // ./node_modules/@wordpress/customize-widgets/build-module/controls/inserter-outer-section.js
  /**
   * WordPress dependencies
   */
  ...
  external_wp_compose_namespaceObject.createHigherOrderComponent)(
    (BlockEdit) => (props) => {
      ...
      const { removeBlock } = (0, external_wp_data_namespaceObject.useDispatch)(
        external_wp_blockEditor_namespaceObject.store,
      );
