...
(() => {
  ...
  var e = {
      d: (p, n) => {
        for (var r in n)
          e.o(n, r) &&
            !e.o(p, r) &&
            Object.defineProperty(p, r, { enumerable: !0, get: n[r] });
      },
      o: (e, p) => Object.prototype.hasOwnProperty.call(e, p),
      r: (e) => {
  ...
  function r(e, p) {
    const r = (function (e) {
      ...
      for (; (r = t.match(n)); ) {
        const e = r.index;
        p.push(t.slice(0, e)), p.push(r[0]), (t = t.slice(e + r[0].length));
      }
      return t.length && p.push(t), p;
    })(e);
    let t = !1;
    ...
    for (let e = 1; e < r.length; e += 2)
      for (let n = 0; n < c.length; n++) {
        const l = c[n];
        if (-1 !== r[e].indexOf(l)) {
          (r[e] = r[e].replace(new RegExp(l, "g"), p[l])), (t = !0);
          break;
        }
      }
    return t && (e = r.join("")), e;
  ...
  function t(e, p = !0) {
    ...
    if (-1 !== (e += "\n").indexOf("<pre")) {
      ...
      for (let r = 0; r < p.length; r++) {
        ...
        n.push([l, t.substr(c) + "</pre>"]), (e += t.substr(0, c) + l);
      }
      e += r;
    }
    const t =
