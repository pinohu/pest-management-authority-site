/******/ (() => {
  ...
  const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/@wordpress/nux/build-module/store/reducer.js
  /**
      ...
      for (const tipIds of state.guides) {
        if (tipIds.includes(tipId)) {
          const nonDismissedTips = tipIds.filter(
            (tId) =>
              !Object.keys(state.preferences.dismissedTips).includes(tId),
          );
  ...
  const external_wp_element_namespaceObject = window["wp"]["element"]; // external ["wp","primitives"]
  const external_wp_primitives_namespaceObject = window["wp"]["primitives"]; // external "ReactJSXRuntime"
  const external_ReactJSXRuntime_namespaceObject = window["ReactJSXRuntime"]; // ./node_modules/@wordpress/icons/build-module/library/close.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const library_close = close_close; // ./node_modules/@wordpress/nux/build-module/components/dot-tip/index.js
  ...
  )(DotTip); // ./node_modules/@wordpress/nux/build-module/index.js
