/******/ (() => {
  ...
  const external_wp_i18n_namespaceObject = window["wp"]["i18n"]; // ./node_modules/@wordpress/annotations/build-module/store/constants.js
  /**
   * The identifier for the data store.
   *
   * @type {string}
   */
  const STORE_NAME = "core/annotations"; // ./node_modules/@wordpress/annotations/build-module/format/annotation.js
  ...
  const external_wp_hooks_namespaceObject = window["wp"]["hooks"]; // external ["wp","data"]
  const external_wp_data_namespaceObject = window["wp"]["data"]; // ./node_modules/@wordpress/annotations/build-module/block/index.js
  /**
   * WordPress dependencies
   */
  ...
  /* harmony default export */ const reducer = annotations; // ./node_modules/@wordpress/annotations/build-module/store/selectors.js
  ...
  /* harmony default export */ const esm_browser_stringify =
    /* unused pure expression or super */ null && stringify; // ./node_modules/@wordpress/annotations/node_modules/uuid/dist/esm-browser/v4.js
  ...
  /* harmony default export */ const esm_browser_v4 = v4; // ./node_modules/@wordpress/annotations/build-module/store/actions.js
  /**
  ...
  (0, external_wp_data_namespaceObject.register)(store); // ./node_modules/@wordpress/annotations/build-module/index.js
