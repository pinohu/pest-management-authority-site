<?php
/**
 * Alternative wp-config.php for pestmanagementscience.com
 * Use this if the main wp-config.php doesn't work
 */

// ** Database settings - ALTERNATIVE HOSTS FOR 20i ** //
define('DB_NAME', 'pestmanagementsite-323038c8c2');  
define('DB_USER', 'pestmanagementsite-323038c8c2');   
define('DB_PASSWORD', '8huilc2drh'); 

// Try these hosts if the main one doesn't work:
// define('DB_HOST', 'localhost');  // Most common alternative
// define('DB_HOST', 'mysql.20i.com');  // Another 20i possibility
// define('DB_HOST', 'sdb-s.hosting.stackcp.net');  // Slightly different
define('DB_HOST', 'localhost');  // Start with localhost
