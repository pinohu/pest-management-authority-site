(function ($) {
  jQuery(document).ready(function () {
    ...
    function select2Initialize() {
      ...
      $("#cat-type").select2({
        placeholder:
          typeof directorist.i18n_text !== "undefined" &&
          directorist.i18n_text.category_selection,
        allowClear: true,
      ...
      $("#loc-type").select2({
        placeholder:
          typeof directorist.i18n_text !== "undefined" &&
          directorist.i18n_text.location_selection,
        allowClear: true,
        templateResult: function (data) {
          // We only really care if there is an element to pull classes from
          if (!data.element) {
    ...
    function directorist_callingSlider() {
      const minValueWrapper = document.querySelector(
        ".directorist-range-slider-value",
      );
      var default_args = {
        maxValue: 1000,
    ...
    $("body").on(
      "click",
      ".directorist-listings-with-map-listings .directorist-viewas .directorist-viewas__item",
      function () {
        ...
        $.ajax({
          ...
          success: function (html) {
            ...
            if (html.no_listing !== "no_listing") {
              ...
              $(".directorist-map-columns-two .directorist-map-search").append(
                _listing,
              );
    ...
    $("body").on("click", ".bdmv-directorist-type a", function () {
      ...
      $.ajax({
        ...
        success: function (html) {
          ...
          if ($(window).width() < 1199) {
            if (
              $(".directorist-map-columns-two #js-dlm-search").hasClass(
                "active",
              )
            ) {
              $(".directorist-listing, .directorist-map-listing").hide();
              $(
                ".directorist-map-search-content, .directorist-map-search",
              ).show();
            } else if (
              $(".directorist-map-columns-two #js-dlm-listings").hasClass(
                "active",
              )
            ) {
              $(
              ...
              if (
                $(".directorist-map-search .directorist-listing ").length === 2
              ) {
                $(
                  ".directorist-map-search-content + .directorist-listing ",
                ).hide();
              }
            } else if (
              ...
              $(
                ".directorist-map-listing, .directorist-ajax-search-result",
              ).show();
              $(
              ...
              $(".directorist-map-columns-three #js-dlm-search").hasClass(
                "active",
              )
            ) {
              $(
              ...
              $(".directorist-map-columns-three #js-dlm-listings").hasClass(
                "active",
              )
            ) {
              $(
