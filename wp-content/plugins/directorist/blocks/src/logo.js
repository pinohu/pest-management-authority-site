export default function getLogo() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 222 221.7">
      ...
      >
        <stop offset="0" stopColor="#2ae498" />
        <stop offset=".01117462" stopColor="#2ae299" />
        <stop offset=".4845" stopColor="#359dca" />
        <stop offset=".8263" stopColor="#3b72e9" />
        <stop offset="1" stopColor="#3e62f5" />
      </linearGradient>
      <path
