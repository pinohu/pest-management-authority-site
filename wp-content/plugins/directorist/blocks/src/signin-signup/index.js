        ...
        <InspectorControls>
          <PanelBody title={__("Sign-In Settings", "directorist")}>
            <TextControl
              ...
              onChange={(value) =>
                setAttributes({ signin_username_label: value })
              }
            />
            <TextControl
            ...
            <TextControl
              ...
              onChange={(value) =>
                setAttributes({ recovery_password_label: value })
              }
            />
          </PanelBody>
            ...
            {attributes.registration ? (
              <Fragment>
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ signup_button_label: value })
                  }
                />
                <ToggleControl
                  ...
                  onChange={(value) =>
                    setAttributes({ signin_after_signup: value })
                  }
                />
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ signup_redirect_url: value })
                  }
                />
                <TextControl
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ signin_linking_text: value })
                  }
                />
              </Fragment>
            ) : null}
            ...
            <Fragment>
              <PanelBody title={__("User Role Settings", "directorist")}>
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ author_role_label: value })
                  }
                />
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ user_role_label: value })
                  }
                />
              </PanelBody>
              ...
              <PanelBody title={__("Website Settings", "directorist")}>
                ...
                <ToggleControl
                  ...
                  onChange={(value) =>
                    setAttributes({ website_required: value })
                  }
                />
              </PanelBody>
              ...
              <PanelBody title={__("Name Fields", "directorist")}>
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ firstname_label: value })
                  }
                />
                <ToggleControl
                  ...
                  onChange={(value) =>
                    setAttributes({ firstname_required: value })
                  }
                />
                ...
                <ToggleControl
                  ...
                  onChange={(value) =>
                    setAttributes({ lastname_required: value })
                  }
                />
              </PanelBody>
              ...
              <PanelBody title={__("Privacy & Terms", "directorist")}>
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ privacy_linking_text: value })
                  }
                />
                ...
                <TextControl
                  ...
                  onChange={(value) =>
                    setAttributes({ terms_linking_text: value })
                  }
                />
              </PanelBody>
            </Fragment>
          ...
          <PanelBody title={__("Recovery Password Settings", "directorist")}>
            <TextControl
              ...
              onChange={(value) =>
                setAttributes({ recovery_password_linking_text: value })
              }
            />
          </PanelBody>
        </InspectorControls>
