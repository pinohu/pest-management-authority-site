      ...
      <Fragment>
        <InspectorControls>
          <PanelBody title={__("General", "directorist")} initialOpen={true}>
            ...
            <ToggleControl
              label={__("Display Title & Subtitle", "directorist")}
            ...
            <ToggleControl
              label={__("Display More Filters Button", "directorist")}
            ...
            {more_filters_button ? (
              <ToggleControl
                label={__("Display Apply Filters Button", "directorist")}
            ...
            {more_filters_button ? (
              <ToggleControl
                label={__("Display Reset Filters Button", "directorist")}
            ...
            <ToggleControl
              label={__("Logged In User Can View Only", "directorist")}
