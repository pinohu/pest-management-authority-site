!(function () {
  ...
  var r = window.wp.blocks,
    ...
    n = (window.wp.i18n, window.lodash, window.ReactJSXRuntime);
  function i() {
    return (0, n.jsxs)("svg", {
      ...
      children: [
        (0, n.jsxs)("linearGradient", {
          ...
          children: [
            (0, n.jsx)("stop", { offset: "0", "stop-color": "#2ae498" }),
            (0, n.jsx)("stop", {
              offset: ".01117462",
              "stop-color": "#2ae299",
            }),
            (0, n.jsx)("stop", { offset: ".4845", "stop-color": "#359dca" }),
            (0, n.jsx)("stop", { offset: ".8263", "stop-color": "#3b72e9" }),
            (0, n.jsx)("stop", { offset: "1", "stop-color": "#3e62f5" }),
          ],
        }),
        (0, n.jsx)("path", {
  ...
  var c = JSON.parse('{"UU":"directorist/payment-receipt"}');
  function s(t, e) {
    var r = Object.keys(t);
  ...
  function f(t) {
    for (var r = 1; r < arguments.length; r++) {
      ...
      r % 2
        ? s(Object(o), !0).forEach(function (r) {
            e(t, r, o[r]);
          })
