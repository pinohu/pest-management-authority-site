    ...
    (function () {
      ...
      function j(e) {
        return e.map(function (e) {
          return {
            value: e.slug,
            label: (0, S.truncate)(T(e.name), { length: 30 }),
          };
        });
      }
      function _(e) {
        return e.map(function (e) {
          return {
            value: e.id,
            label: (0, S.truncate)(T(e.title.rendered), { length: 30 }),
          };
        });
      }
      function T(e) {
        ...
        return (0, x.jsxs)("span", {
          ...
          children: [
            (0, x.jsxs)("span", {
              ...
              children: [
                (0, x.jsx)(V.VisuallyHidden, { as: "span", children: k }),
      ...
      var Se = (0, V.withSpokenMessages)((0, P.withInstanceId)(ke)),
      ...
      var Ie = directoristBlockConfig,
        Pe = Ie.categoryTax,
        Ee = (Ie.locationTax, Ie.postType, Ie.tagTax, Ie.typeTax),
        Le = (0, k.withSelect)(function (e) {
          return {
            items: e("core").getEntityRecords("taxonomy", Ee, {
              per_page: -1,
              order: "asc",
              orderby: "name",
            }),
            ...
            e.items
              ? ((t = (
                  ...
                  return (0, x.jsx)(
                    "li",
                    {
                      children: (0, x.jsx)(V.CheckboxControl, {
                        label: (0, S.truncate)(T(t.name), { length: 30 }),
              ...
              : (t = [
                  (0, x.jsx)("li", { children: (0, x.jsx)(V.Spinner, {}) }),
                ]),
            (0, x.jsxs)(p.Fragment, {
              children: [
                (0, x.jsx)(V.BaseControl, {
        ...
        Ve = (0, k.withSelect)(function (e, t) {
        ...
        Ae = function (e) {
          return (0, x.jsx)(
            ...
            _e(
              ...
              {
                taxonomy: Pe,
                label: (0, d.__)("Select Categories", "directorist"),
              },
            ),
          );
        },
      ...
      (0, k.withSelect)(function (e, t) {
        ...
        return { options: (0, S.isEmpty)(o) ? [] : _(o) };
      })(Be);
      var Me = (0, x.jsx)(A.SVG, {
          xmlns: "http://www.w3.org/2000/svg",
          viewBox: "0 0 24 24",
          children: (0, x.jsx)(A.Path, {
        ...
        Fe = JSON.parse(
          '{"UU":"directorist/all-categories","uK":{"view":{"type":"string","enum":["grid","list"],"default":"grid"},"orderby":{"type":"string","enum":["id","count","name","slug"],"default":"id"},"order":{"type":"string","enum":["asc","desc"],"default":"desc"},"cat_per_page":{"type":"number","default":6},"columns":{"type":"number","enum":[1,2,3,4,6],"default":3},"slug":{"type":"string","default":""},"logged_in_user_only":{"type":"boolean","default":false},"redirect_page_url":{"type":"string","default":""},"directory_type":{"type":"string","default":""},"default_directory_type":{"type":"string","default":""}}}',
        );
      function Re(e, t) {
        var n = Object.keys(e);
        if (Object.getOwnPropertySymbols) {
      ...
      (0, a.registerBlockType)(Fe.UU, {
          ...
          from: [
            ...
            },
            {
              ...
              transform: function (e) {
                return (
                  (e.cat_per_page = e.loc_per_page),
                  (e.slug = ""),
                  delete e.loc_per_page,
                  (0, a.createBlock)("directorist/all-categories", e)
                );
              },
            },
          ],
        ...
        edit: function (e) {
          var t = e.attributes,
            ...
            g = t.columns,
            v = t.slug,
            y = t.logged_in_user_only,
            m = (t.redirect_page_url, t.directory_type),
            b = t.default_directory_type,
            w = v ? v.split(",") : [],
            k = m ? m.split(",") : [];
          return (0, x.jsxs)(p.Fragment, {
            children: [
              (0, x.jsx)(l.BlockControls, {
                children: (0, x.jsxs)(V.ToolbarGroup, {
                  children: [
                    (0, x.jsx)(V.ToolbarButton, {
                      isPressed: "grid" === a,
                      icon: Me,
                      label: (0, d.__)("Grid View", "directorist"),
                      onClick: function () {
                        return n({ view: "grid" });
                      },
                    }),
                    (0, x.jsx)(V.ToolbarButton, {
                      isPressed: "list" === a,
                      icon: Ne,
                      label: (0, d.__)("List View", "directorist"),
                      onClick: function () {
                        return n({ view: "list" });
                      },
                    }),
                ...
                children: (0, x.jsxs)(V.PanelBody, {
                  ...
                  children: [
                    directoristBlockConfig.multiDirectoryEnabled
                      ...
                      : "",
                    (0, x.jsx)(V.SelectControl, {
                      label: (0, d.__)("Default View", "directorist"),
                      labelPosition: "side",
                      value: a,
                      options: [
                        {
                          label: (0, d.__)("Grid", "directorist"),
                          value: "grid",
                        },
                        {
                          label: (0, d.__)("List", "directorist"),
                          value: "list",
                        },
                      ],
                      onChange: function (e) {
                    ...
                    "grid" === a
                      ? (0, x.jsx)(V.SelectControl, {
                          label: (0, d.__)("Columns", "directorist"),
                          labelPosition: "side",
                          value: g,
                          options: [
                            {
                              label: (0, d.__)("1 Column", "directorist"),
                              value: 1,
                            },
                            {
                              label: (0, d.__)("2 Columns", "directorist"),
                              value: 2,
                            },
                            {
                              label: (0, d.__)("3 Columns", "directorist"),
                              value: 3,
                            },
                            {
                              label: (0, d.__)("4 Columns", "directorist"),
                              value: 4,
                            },
                            {
                              label: (0, d.__)("6 Columns", "directorist"),
                              value: 6,
                            },
                          ],
                          onChange: function (e) {
                      ...
                      : "",
                    (0, x.jsx)(V.TextControl, {
                      label: (0, d.__)("Number Of Categories", "directorist"),
                      type: "number",
                      value: h,
                      onChange: function (e) {
                        return n({ cat_per_page: Number(e) });
                      },
                      className: "directorist-gb-fixed-control",
                      help: (0, d.__)(
                    ...
                    (0, x.jsx)(V.SelectControl, {
                      label: (0, d.__)("Order By", "directorist"),
                      labelPosition: "side",
                      value: u,
                      options: [
                        { label: (0, d.__)("ID", "directorist"), value: "id" },
                        {
                          label: (0, d.__)("Count", "directorist"),
                          value: "count",
                        },
                        {
                          label: (0, d.__)("Name", "directorist"),
                          value: "name",
                        },
                        {
                          label: (0, d.__)("Categories", "directorist"),
                          value: "slug",
                        },
                      ],
                      onChange: function (e) {
                    ...
                    "slug" === u
                      ...
                      : "",
                    (0, x.jsx)(V.SelectControl, {
                      label: (0, d.__)("Order", "directorist"),
                      labelPosition: "side",
                      value: f,
                      options: [
                        {
                          label: (0, d.__)("ASC", "directorist"),
                          value: "asc",
                        },
                        {
                          label: (0, d.__)("DESC", "directorist"),
                          value: "desc",
                        },
                      ],
                      onChange: function (e) {
