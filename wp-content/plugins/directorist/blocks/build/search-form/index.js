    ...
    (function () {
      ...
      function T(e) {
        return e.map(function (e) {
          return {
            value: e.slug,
            label: (0, _.truncate)(j(e.name), { length: 30 }),
          };
        });
      }
      function O(e) {
        return e.map(function (e) {
          return {
            value: e.id,
            label: (0, _.truncate)(j(e.title.rendered), { length: 30 }),
          };
        });
      }
      function j(e) {
      ...
      function M(e) {
        var t = e.value,
          ...
          v = e.termPosition,
          y = e.termsCount,
          m = (0, P.useInstanceId)(M),
          b = I()("components-form-token-field__token", {
            "is-error": "error" === o,
        ...
        return (0, x.jsxs)("span", {
          ...
          children: [
            (0, x.jsxs)("span", {
              ...
              id: "components-form-token-field__token-text-".concat(m),
              children: [
                (0, x.jsx)(A.VisuallyHidden, { as: "span", children: k }),
            ...
            (0, x.jsx)(A.Button, {
              ...
              label: g.remove,
              "aria-describedby":
                "components-form-token-field__token-text-".concat(m),
            }),
          ],
        });
      }
      ...
      function ue(e, t, n) {
        ...
        (null == r || r <= 0) &&
          ((r = void 0),
          (null == (s = Y(e, t)) || Number(s) < 0) && (s = e.style[t] || 0),
          (s = parseFloat(s) || 0)),
          void 0 === n && (n = i ? 1 : -1);
        var a = void 0 !== r || i,
          l = r || s;
      ...
      function de(e, t, n) {
        ...
        if ("object" !== z(t))
          return void 0 !== o
            ...
            : Y(e, t);
        for (var r in t) t.hasOwnProperty(r) && de(e, r, t[r]);
      }
      oe(["width", "height"], function (e) {
      ...
      var fe = (function (e) {
      ...
      })(
        {
          ...
          offset: function (e, t) {
            ...
            !(function (e, t) {
              "static" === de(e, "position") && (e.style.position = "relative");
              var n,
                o,
                r = X(e),
                i = {};
              for (o in t)
                t.hasOwnProperty(o) &&
                  ((n = parseFloat(de(e, o)) || 0), (i[o] = n + t[o] - r[o]));
              de(e, i);
            })(e, t);
          },
          isWindow: ae,
                  ...
                  (function (e, t, n) {
                    ...
                    k
                      ? ((y = t),
                        (w = fe.height(y)),
                        (b = fe.width(y)),
                        (m = { left: fe.scrollLeft(y), top: fe.scrollTop(y) }),
                        (g = {
                          left: _.left - m.left - l,
                          top: _.top - m.top - a,
                        }),
                        (v = {
                          left: _.left + S - (m.left + b) + c,
                          top: _.top + x - (m.top + w) + u,
                        }),
                        (h = m))
                      : ((p = fe.offset(t)),
                        (d = t.clientHeight),
            ...
            },
            {
              ...
              value: function () {
                ...
                return (0, x.jsx)("ul", {
                  ...
                  role: "listbox",
                  children: (0, _.map)(this.props.suggestions, function (t, n) {
            ...
            g(
              ...
              [
                ...
                },
                {
                  ...
                  value: function (e) {
                    var t = this;
                    return (0, _.some)(this.props.value, function (n) {
                ...
                },
                {
                  ...
                  value: function () {
                    var e = (0, _.map)(this.props.value, this.renderToken);
                    return (
      ...
      ke.defaultProps = {
        ...
        tokenizeOnSpace: !1,
        messages: {
          added: (0, d.__)("Item added."),
          removed: (0, d.__)("Item removed."),
          remove: (0, d.__)("Remove item"),
        },
      };
      var _e = (0, A.withSpokenMessages)((0, P.withInstanceId)(ke)),
      ...
      var je = directoristBlockConfig,
        ...
        Ie = (0, k.withSelect)(function (e) {
          return {
            items: e("core").getEntityRecords("taxonomy", Ce, {
              per_page: -1,
              order: "asc",
              orderby: "name",
            }),
            ...
            e.items
              ? ((t = (
                  ...
                  return (0, x.jsx)(
                    "li",
                    {
                      children: (0, x.jsx)(A.CheckboxControl, {
                        label: (0, _.truncate)(j(t.name), { length: 30 }),
                        checked: e.selected.includes(t.slug),
                        onChange: function (n) {
                          var o = n
                            ? [].concat(w(e.selected), [t.slug])
                            : (0, _.without)(e.selected, t.slug);
                          e.onChange(o);
                        },
                      }),
                    },
              ...
              : (t = [
                  (0, x.jsx)("li", { children: (0, x.jsx)(A.Spinner, {}) }),
                ]),
            (0, x.jsxs)(p.Fragment, {
              children: [
                (0, x.jsx)(A.BaseControl, {
                  label: (0, d.__)("Directory Types", "directorist"),
              ...
              [
                {
                  key: "getDerivedStateFromProps",
                  value: function (e, t) {
                    return (0, _.isEmpty)(e.options) &&
                      (0, _.isEmpty)(t.options)
                      ? null
                      : {
                          options: (0, _.uniqBy)(
        ...
        Ee =
          ((0, k.withSelect)(function (e, t) {
            ...
            return { options: (0, _.isEmpty)(o) ? [] : T(o) };
          })(Pe),
          (function (e) {
            function t(e) {
              var n;
      ...
      (0, a.registerBlockType)(Le.UU, {
        ...
        edit: function (e) {
          var t = e.attributes,
            n = e.setAttributes,
            o = s((0, p.useState)(!0), 2),
            r = o[0],
            i = o[1],
            a = t.show_title_subtitle,
            u = t.search_bar_title,
            f = t.search_bar_sub_title,
            h = t.more_filters_button,
            g = t.more_filters_text,
            v = t.reset_filters_button,
            y = t.apply_filters_button,
            m = t.reset_filters_text,
            b = t.apply_filters_text,
            w = t.more_filters_display,
            k = t.logged_in_user_only,
            _ = t.directory_type,
            S = t.default_directory_type,
            T = t.show_popular_category,
            O = _ ? _.split(",") : [];
          return (0, x.jsxs)(p.Fragment, {
            children: [
              (0, x.jsx)(l.InspectorControls, {
                children: (0, x.jsxs)(A.PanelBody, {
                  title: (0, d.__)("General", "directorist"),
                  initialOpen: !0,
                  children: [
                    ...
                    (0, x.jsx)(A.ToggleControl, {
                      ...
                      checked: a,
                      onChange: function (e) {
                        return n({ show_title_subtitle: e });
                      },
                    }),
                    a
                      ? (0, x.jsx)(A.TextControl, {
                          label: (0, d.__)("Search Form Title", "directorist"),
                          type: "text",
                          value: u,
                          onChange: function (e) {
                            return n({ search_bar_title: e });
                          },
                        })
                      : null,
                    a
                      ? (0, x.jsx)(A.TextControl, {
                          ...
                          value: f,
                          onChange: function (e) {
                            return n({ search_bar_sub_title: e });
                          },
                        })
                      : null,
                    (0, x.jsx)(A.ToggleControl, {
                      ...
                      checked: h,
                      onChange: function (e) {
                        return n({ more_filters_button: e });
                      },
                    }),
                    h
                      ? (0, x.jsx)(A.TextControl, {
                    ...
                    h
                      ? (0, x.jsx)(A.ToggleControl, {
                          ...
                          checked: y,
                          onChange: function (e) {
                            return n({ apply_filters_button: e });
                          },
                        })
                      : null,
                    h && y
                      ? (0, x.jsx)(A.TextControl, {
                          label: (0, d.__)("Apply Filters Text", "directorist"),
                          type: "text",
                          value: b,
                          onChange: function (e) {
                            return n({ apply_filters_text: e });
                          },
                        })
                      : null,
                    h
                      ? (0, x.jsx)(A.ToggleControl, {
                          ...
                          checked: v,
                          onChange: function (e) {
                            return n({ reset_filters_button: e });
                          },
                        })
                      : null,
                    h && v
                      ? (0, x.jsx)(A.TextControl, {
                          label: (0, d.__)("Reset Filters Text", "directorist"),
                          type: "text",
                          value: m,
                          onChange: function (e) {
                            return n({ reset_filters_text: e });
                          },
                        })
                      : null,
                    h
                      ? (0, x.jsx)(A.SelectControl, {
                          label: (0, d.__)("More Filter By", "directorist"),
                          labelPosition: "side",
                          value: w,
                          options: [
                            {
                              label: (0, d.__)("Overlapping", "directorist"),
                              value: "overlapping",
                            },
                            {
                              label: (0, d.__)("Sliding", "directorist"),
                              value: "sliding",
                            },
                            {
                              label: (0, d.__)("Always Open", "directorist"),
                              value: "always_open",
                            },
                          ],
                          onChange: function (e) {
                            return n({ more_filters_display: e });
                          },
                    ...
                    (0, x.jsx)(A.ToggleControl, {
                      ...
                      checked: T,
                      onChange: function (e) {
                        return n({ show_popular_category: e });
                      },
                      help: (0, d.__)(
