!(function () {
  ...
  var e,
    t = {
      14: function () {
        ...
        var g = JSON.parse('{"UU":"directorist/search-modal"}');
        (0, e.registerBlockType)(g.UU, {
          ...
          edit: function (n) {
            var l,
              ...
              S = y.text,
              C = y.width,
              B = (y.showUserAvatar, y.showDashboardMenu, y.styleDisplay),
              P = (function (e, t) {
                return (
                  (function (e) {
              ...
              A = (P[0], P[1]),
              N = (0, a.__experimentalUseBorderProps)(y),
              D = (0, a.__experimentalUseColorProps)(y),
              E = (0, a.__experimentalGetSpacingClassesAndStyles)(y),
              ...
              T = (function (t) {
                var r = (0, p.useDispatch)(a.store),
                  n = r.replaceBlocks,
                  o = r.selectionChange,
                  l = (0, p.useSelect)(a.store),
                  i = l.getBlock,
                  c = l.getBlockRootClientId,
                  d = l.getBlockIndex,
                  y = (0, s.useRef)(t);
                return (
                  (y.current = t),
          ...
          save: function (e) {
            var t,
              ...
              m = "button" === h,
              g = c || "button",
              x = (0, a.__experimentalGetBorderClassesAndStyles)(n),
              j = (0, a.__experimentalGetColorClassesAndStyles)(n),
              _ = (0, a.__experimentalGetSpacingClassesAndStyles)(n),
              O = (0, a.__experimentalGetShadowClassesAndStyles)(n),
              k = i(
                "wp-block-button__link",
                j.className,
                x.className,
              ...
              S = w(w(w(w({}, x.style), j.style), _.style), O.style),
              C = i(
                l,
                o(
                  o(
  ...
  (n.m = t),
    (e = []),
    (n.O = function (t, r, o, l) {
      if (!r) {
        var i = 1 / 0;
        for (u = 0; u < e.length; u++) {
          (r = e[u][0]), (o = e[u][1]), (l = e[u][2]);
