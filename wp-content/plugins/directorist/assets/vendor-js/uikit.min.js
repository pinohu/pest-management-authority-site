(function (t) {
  ...
  var i,
    ...
    n,
    o = {},
    s = window.UIkit || void 0;
  if (
    ((o.version = "2.27.5"),
    (o.noConflict = function () {
      return s && ((window.UIkit = s), (t.UIkit = s), (t.fn.uk = s.fn)), o;
    }),
    (window.UIkit2 = o),
    s || (window.UIkit = o),
    (o.$ = t),
    ...
    (o.Utils.isInView = function (i, e) {
      ...
      var s = o.$win.scrollLeft(),
        ...
        c = r.top;
      return (
        (e = t.extend({ topoffset: 0, leftoffset: 0 }, e)),
        c + n.height() >= a &&
          c - e.topoffset <= a + o.$win.height() &&
          l + n.width() >= s &&
          l - e.leftoffset <= s + o.$win.width()
      );
    }),
    (o.Utils.checkDisplay = function (i, e) {
      var n = o.$(
    ...
    (o.Utils.options = function (i) {
      ...
      if (-1 != e)
        try {
          n = o.Utils.str2json(i.substr(e));
        } catch (t) {}
      return n;
    }),
    (o.Utils.animate = function (i, e) {
      var n = t.Deferred();
      return (
        (i = o.$(i)),
        i
          .css("display", "none")
          .addClass(e)
          .one(o.support.animation.end, function () {
            i.removeClass(e), n.resolve();
          }),
        i.css("display", ""),
        n.promise()
      );
    ...
    (o.Utils.focus = function (i, e) {
      if (((i = t(i)), !i.length)) return i;
      var n,
        o = i.find("[autofocus]:first");
      return o.length
        ? o.focus()
        : ((o = i.find(":input" + ((e && "," + e) || "")).first()),
          o.length
            ? o.focus()
            : (i.attr("tabindex") || ((n = 1e3), i.attr("tabindex", n)),
              i[0].focus(),
              n && i.attr("tabindex", ""),
              i));
    }),
    (o.Utils.events = {}),
    (o.Utils.events.click = o.support.touch ? "tap" : "click"),
    (o.fn = function (i, e) {
      var n = arguments,
        s = i.match(/^([a-z\-]+)(?:\.([a-z]+))?/i),
        a = s[1],
      ...
      return o[a]
        ? this.each(function () {
            var i = t(this),
              s = i.data(a);
            s || i.data(a, (s = o[a](this, r ? void 0 : e))),
    ...
    (t.UIkit = o),
    (t.fn.uk = o.fn),
    (o.langdirection = "rtl" == o.$html.attr("dir") ? "right" : "left"),
    (o.components = {}),
    (o.component = function (i, e, n) {
      if (o.components[i] && !n) return o.components[i];
      var s = function (e, n) {
        var a = this;
        return (
          (this.UIkit = o),
          (this.element = e ? o.$(e) : null),
          ...
          if (arguments.length)
            switch (arguments.length) {
              case 1:
                ...
                break;
              case 2:
                (e = t(arguments[0])), (n = arguments[1]);
            }
          return e && e.data(i) ? e.data(i) : new o.components[i](e, n);
        }),
        o.domready && o.component.boot(i),
        s
      );
    }),
    ...
    (o.component.boot = function (t) {
      o.components[t].prototype &&
        o.components[t].prototype.boot &&
        !o.components[t].booted &&
        (o.components[t].prototype.boot.apply(o, []),
        (o.components[t].booted = !0));
    }),
    ...
    (o.on = function (t, i, e) {
      return (
        t && t.indexOf("ready.uk.dom") > -1 && o.domready && i.apply(o.$doc),
        o.$doc.on(t, i, e)
      );
    }),
    (o.one = function (t, i, e) {
      return t && t.indexOf("ready.uk.dom") > -1 && o.domready
        ? (i.apply(o.$doc), o.$doc)
        : o.$doc.one(t, i, e);
    }),
    ...
    (o.domObserve = function (t, i) {
      o.support.mutationobserver &&
        ...
        o.$(t).each(function () {
          ...
          if (!e.data("observer"))
            try {
              var n = new o.support.mutationobserver(
                o.Utils.debounce(function (n) {
    ...
    (o.init = function (t) {
      (t = t || document),
        o.domObservers.forEach(function (i) {
          i(t);
        });
    }),
    ...
    document.addEventListener(
      ...
      ((n = function () {
        (o.$body = o.$("body")),
          o.trigger("beforeready.uk.dom"),
          o.component.bootComponents();
        var i,
          e,
          n = requestAnimationFrame(
            ...
            (e = function () {
              ...
              (i.x == t && i.y == s) ||
                (t != i.x ? (i.dir.x = t > i.x ? 1 : -1) : (i.dir.x = 0),
                s != i.y ? (i.dir.y = s > i.y ? 1 : -1) : (i.dir.y = 0),
                (i.x = t),
                (i.y = s),
                o.$doc.trigger("scrolling.uk.document", [
                  { dir: { x: i.dir.x, y: i.dir.y }, x: t, y: s },
                ])),
        ...
        if (
          ...
          o.trigger("afterready.uk.dom"),
          (o.domready = !0),
          o.support.mutationobserver)
        ) {
          var s = o.Utils.debounce(function () {
    ...
    o.$html.addClass(o.support.touch ? "uk-touch" : "uk-notouch"),
    o.support.touch)
  ) {
    var a,
      r = !1,
    ...
    o.$html
      .on("mouseenter touchstart MSPointerDown pointerdown", c, function () {
        r && t("." + l).removeClass(l), (r = t(this).addClass(l));
      })
      .on("mouseleave touchend MSPointerUp pointerup", function (i) {
        (a = t(i.target).parents(c)), r && r.not(a).removeClass(l);
      });
  }
  return o;
}),
  (function (t) {
    ...
    t.component("stackMargin", {
      ...
      (n = {}),
      (t.Utils.inlineSvg = function (i, e) {
        t.$(i || 'img[src$=".svg"]', e || document).each(function () {
          var i = t.$(this),
            e = i.attr("src");
          if (!n[e]) {
            var o = t.$.Deferred();
          ...
          n[e].then(function (e) {
            var n = t.$(e).clone();
            i.attr("id") && n.attr("id", i.attr("id")),
              i.attr("class") && n.attr("class", i.attr("class")),
              i.attr("style") && n.attr("style", i.attr("style")),
              i.attr("width") &&
                (n.attr("width", i.attr("width")),
                i.attr("height") || n.removeAttr("height")),
              i.attr("height") &&
                (n.attr("height", i.attr("height")),
                i.attr("width") || n.removeAttr("width")),
              i.replaceWith(n);
          });
        });
      }),
            ...
            n.each(function (n) {
              ...
              !c ||
                ...
                r.data(
                  "scrollspy-idle",
                  setTimeout(function () {
                    r.addClass("uk-scrollspy-inview").toggleClass(d).width(),
              ...
              var s,
                ...
                h = (function () {
                  for (var t = 0; t < e.length; t++)
                    if (e[t].offset().top - c.options.topoffset >= d)
                      return e[t];
                })();
              if (!h) return;
              c.options.closest
    ...
    t.component("dropdown", {
        ...
        t.$html.on(
          ...
          function (e) {
            ...
            if (!n.data("dropdown")) {
              ...
              ("click" == e.type ||
                ("mouseenter" == e.type && "hover" == o.options.mode)) &&
                o.element.trigger(i),
      ...
      init: function () {
        ...
        (this.dropdown = this.find(this.options.dropdownSelector)),
          ...
          (this.justified =
            !!this.options.justify && t.$(this.options.justify)),
      ...
      checkDimensions: function () {
        if (this.dropdown.length) {
          this.dropdown
            ...
            .css({ topLeft: "", left: "", marginLeft: "", marginRight: "" }),
            this.justified &&
          ...
          if (
            ...
            var f;
            switch (
              this.checkBoundary(n.left + u.left, n.top + u.top, r, l, c)
            ) {
              case "x":
                "x" !== this.options.preventflip && (f = o.x[d] || "right-top");
                break;
              case "y":
                "y" !== this.options.preventflip && (f = o.y[d] || "top-left");
                break;
              case "xy":
                this.options.preventflip || (f = o.xy[d] || "right-bottom");
            }
            f &&
              ((e = f.split("-")),
              (u = h[f] ? h[f] : h["bottom-left"]),
              a.addClass("uk-dropdown-autoflip"),
              this.checkBoundary(n.left + u.left, n.top + u.top, r, l, c) &&
                ((e = d.split("-")), (u = h[d] ? h[d] : h["bottom-left"])));
          }
          r > c &&
      ...
      checkBoundary: function (i, e, n, o, s) {
        var a = "";
        return (
          (i < 0 || i - t.$win.scrollLeft() + n > s) && (a += "x"),
          (e - t.$win.scrollTop() < 0 ||
      ...
      boot: function () {
        t.ready(function (i) {
          t.$("[data-uk-grid-match]", i).each(function () {
            var i = t.$(this);
            i.data("gridMatchHeight") ||
              t.gridMatchHeight(
                i,
                t.Utils.options(i.attr("data-uk-grid-match")),
              );
          });
        });
      },
        ...
        boot: function () {
          t.ready(function (i) {
            t.$("[data-uk-grid-margin]", i).each(function () {
              var i = t.$(this);
              i.data("gridMargin") ||
                t.gridMargin(i, t.Utils.options(i.attr("data-uk-grid-margin")));
            });
          });
        },
        init: function () {
            ...
            : (i =
                "string" == typeof i || "number" == typeof i
                  ...
                  : t
                      .$("<div></div>")
                      .html(
                        "UIkit2.modal Error: Unsupported data type: " +
                          typeof i,
                      )),
          ...
          if (this.isActive() || t) {
            ...
            if (
              ...
              n + o < window.innerHeight
                ? this.dialog.css({ top: window.innerHeight / 2 - n / 2 - o })
                : this.dialog.css({ top: "" });
            }
          }
        },
        ...
        show: function (n, o) {
          if (((n = t.$(n)), n.length)) {
            ...
            (i = { x: window.pageXOffset, y: window.pageYOffset }),
              ...
              ("push" != o.mode && "reveal" != o.mode) ||
                s.css(
                  r ? "margin-right" : "margin-left",
                  (r ? -1 : 1) * (a.outerWidth() * c),
                ),
              "reveal" == o.mode &&
                a.css("clip", "rect(0, " + a.outerWidth() + "px, 100vh, 0)"),
    ...
    t.component("switcher", {
      ...
      show: function (n, o) {
        if (!this.animating) {
          ...
          isNaN(n)
            ? (n = t.$(n))
            : ((n = n < 0 ? s.length - 1 : n), (n = s.eq(s[n] ? n : 0)));
          var a = this,
            r = t.$(n),
            l =
          ...
          (!1 !== o && t.support.animation) || (l = e.none),
    ...
    t.component("tab", {
      ...
      check: function () {
        ...
        if (i.length) {
          var e,
            n,
            o = i.eq(0).offset().top + Math.ceil(i.eq(0).height() / 2),
            s = !1;
          if (
              ...
              (e = t.$(i.eq(a))),
                ...
                "none" == e.css("float") ||
                  ...
                  (e.hasClass("uk-disabled") ||
                    ((n = t.$(e[0].outerHTML)),
                    n.find("a").data("index", a),
                    this.responsivetab.lst.append(n)),
