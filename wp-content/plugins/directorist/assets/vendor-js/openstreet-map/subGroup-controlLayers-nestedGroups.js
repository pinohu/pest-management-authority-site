jQuery(document).ready(function ($) {
  ...
  var marker = L.marker([-37.8, 175.2])
    .addTo(groupA)
    .bindPopup("Marker at [-37.8, 175.2] in group A");
  L.marker([-37.8, 175.3])
    .addTo(groupB)
    .bindPopup("Marker at [-37.8, 175.3] in group B");
  L.marker([-37.9, 175.2])
    .addTo(groupC)
    .bindPopup("Marker at [-37.9, 175.2] in group C");
  L.marker([-37.9, 175.3])
    .addTo(groupD)
    .bindPopup("Marker at [-37.9, 175.3] in group D");
