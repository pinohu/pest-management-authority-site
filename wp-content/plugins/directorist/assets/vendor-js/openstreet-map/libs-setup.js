(function (global) {
  ...
  var subgroupPathPrefix0 =
    cdn + "leaflet.featuregroup.subgroup" + versionPlaceholder;
  ...
  libs.push({
    ...
    versions: [
      ...
      _makeSubGroupVersionAssets({
        name: "1.0.2",
        sriSrcJs:
          "sha384-svfed/3FeCsVv1Bq0lXOx2+p9iHbHO1ylmU9eoj7PtU5683TiHc/g0FL7FLpwlLL",
      }),
      _makeSubGroupVersionAssets({
        name: "1.0.1",
        sriSrcJs:
          "sha384-jbTL/zsueVL4bMZERISP/PzASzooTdHjfAEmvij+Xmj5m41EDGfE4Ym9gT6Hvho1",
      }),
  ...
  function _makeSubGroupVersionAssets(options) {
    ...
    return {
      ...
      assets: [
        manageLibsVersions.makeScript(
          subgroupPathPrefix + "leaflet.featuregroup.subgroup-src.js",
          versionName,
          options.sriSrcJs,
        ),
      ],
