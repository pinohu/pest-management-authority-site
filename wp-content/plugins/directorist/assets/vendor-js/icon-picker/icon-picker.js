window.IconPicker = function (args) {
  return {
    ...
    init: function () {
      ...
      this.id = id;
      this.container =
        typeof args.container !== "undefined" ? args.container : this.container;
      this.labels =
        typeof args.labels !== "undefined"
          ...
          : this.labels;
      this.onSelect =
        typeof args.onSelect !== "undefined" ? args.onSelect : this.onSelect;
    ...
    renderIcon() {
      ...
      for (const iconGroupKey of Object.keys(this.icons)) {
        ...
        for (const icon of this.icons[iconGroupKey].icons) {
          ...
          const buttonClass =
            this.value === fullIcon ? "cptm-btn-primary" : "cptm-btn-secondery";
          markup += `
    ...
    attachEvents() {
        ...
        elm.addEventListener("click", function (event) {
          ...
          if (body) {
            body
              ...
              .setAttribute("class", `icon-picker__preview-icon ${icon}`);
      ...
      function openModal(event, self) {
        ...
        previewContainer
          .querySelector(".icon-picker__preview-icon")
          .setAttribute("class", "icon-picker__preview-icon " + self.value);
        previewContainer.querySelector(".icon-picker__icon-name").innerHTML =
          selectedIconClassList.length ? selectedIconClassList[1] : "";
      ...
      document
        ...
        .addEventListener("click", (e) => {
          ...
          selector
            .querySelector(".directorist-selected-icon")
            .setAttribute("class", `directorist-selected-icon ${self.value}`);
