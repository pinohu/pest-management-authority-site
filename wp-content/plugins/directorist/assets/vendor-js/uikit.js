...
(function (UI) {
  ...
  UI.Utils.getCssVar = function (name) {
    ...
    try {
      val = JSON.parse(
        (val = getComputedStyle(element, ":before").content.replace(
          /^["'](.*)["']$/,
          "$1",
        )),
      );
            ...
            var navitems,
              ...
              target = (function () {
                for (var i = 0; i < inviews.length; i++) {
                  if (
                    inviews[i].offset().top - $this.options.topoffset >=
                    scrollTop
                  ) {
                    return inviews[i];
                  }
...
(function (UI) {
  ...
  UI.component("dropdown", {
    ...
    boot: function () {
      ...
      // init code
      UI.$html.on(
        triggerevent + ".dropdown.uikit focus pointerdown",
        "[data-uk-dropdown]",
        function (e) {
          var ele = UI.$(this);
          ...
          if (!ele.data("dropdown")) {
            ...
            if (
              e.type == "click" ||
              (e.type == "mouseenter" && dropdown.options.mode == "hover")
            ) {
  ...
  function setContent(content, modal) {
    ...
    if (typeof content === "object") {
      ...
      content = UI.$("<div></div>").html(
        "UIkit2.modal Error: Unsupported data type: " + typeof content,
      );
    }
        ...
        var $body = UI.$("body"),
          ...
          finalize = function () {
            $body
              ...
              .css({ width: "", height: "", marginLeft: "", marginRight: "" });
