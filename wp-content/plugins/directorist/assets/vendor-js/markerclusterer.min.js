...
(MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ =
  ...
  (MarkerClusterer.prototype.fitMapToMarkers = function () {
    for (
      var t, e = this.getMarkers(), r = new google.maps.LatLngBounds(), s = 0;
      (t = e[s]);
      s++
    )
  ...
  (MarkerClusterer.prototype.addToClosestCluster_ = function (t) {
    for (
      var e = 4e4, r = null, s = (t.getPosition(), 0);
      (a = this.clusters_[s]);
      s++
    ) {
      var o = a.getCenter();
    ...
    if (r && r.isMarkerInClusterBounds(t)) r.addMarker(t);
      ...
      a.addMarker(t), this.clusters_.push(a);
    }
  }),
  ...
  (ClusterIcon.prototype.onAdd = function () {
    ...
    var r = this.getPanes();
    r.overlayMouseTarget.appendChild(this.div_);
    var s = this;
    google.maps.event.addDomListener(this.div_, "click", function () {
      s.triggerClusterClick();
    });
  }),
  ...
  (ClusterIcon.prototype.createCss = function (t) {
    var e = [],
      r = this.cluster_.getMarkerClusterer();
    if (r.cssClass_) e.push("top:" + t.y + "px; left:" + t.x + "px;");
    else {
      e.push("background-image:url(" + this.url_ + ");");
      var s = this.backgroundPosition_ ? this.backgroundPosition_ : "0 0";
      e.push("background-position:" + s + ";"),
