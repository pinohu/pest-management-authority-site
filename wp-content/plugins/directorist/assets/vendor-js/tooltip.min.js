(function (t, e) {
      ...
      l = {
        ...
        getTransitionDurationFromElement: function (e) {
          ...
          var n = t(e).css("transition-duration"),
            i = parseFloat(n);
          return i ? ((n = n.split(",")[0]), parseFloat(n) * a) : 0;
        },
        reflow: function (t) {
  ...
  (function (t, e) {
    ...
    var a = (function (t) {
        ...
        _ = (function () {
          ...
          return (
              ...
              if (this.isWithContent() && this._isEnabled) {
                ...
                var h = function () {
                  ...
                  (i._hoverState = null),
                    ...
                    e === d.OUT && i._leave(null, i);
                };
                if (t(this.tip).hasClass(v.FADE)) {
                  var f = n.getTransitionDurationFromElement(this.tip);
                  t(this.tip).one(n.TRANSITION_END, h).emulateTransitionEnd(f);
                } else h();
              }
            }),
            (_.hide = function (e) {
            ...
            (_.addAttachmentClass = function (e) {
              t(this.getTipElement()).addClass(u + "-" + e);
            }),
            ...
            (_.setContent = function () {
              ...
              this.setElementContent(
                t(e.querySelectorAll(E.TOOLTIP_INNER)),
                this.getTitle(),
              ),
                t(e).removeClass(v.FADE + " " + v.SHOW);
            }),
            ...
            (_._enter = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)),
                ...
                e &&
                  (n._activeTrigger["focusin" === e.type ? T.FOCUS : T.HOVER] =
                    !0),
                t(n.getTipElement()).hasClass(v.SHOW) ||
            ...
            (_._leave = function (e, n) {
              ...
              (n = n || t(e.currentTarget).data(i)),
                n ||
                  ...
                  t(e.currentTarget).data(i, n)),
                e &&
                  (n._activeTrigger["focusout" === e.type ? T.FOCUS : T.HOVER] =
                    !1),
            ...
            (_._getConfig = function (e) {
              return (
                ...
                n.typeCheckConfig(i, e, this.constructor.DefaultType),
                e
              );
            }),
            ...
            (c._jQueryInterface = function (e) {
              return this.each(function () {
                ...
                if (
                  ...
                  (n || ((n = new c(this, i)), t(this).data(a, n)),
                  "string" == typeof e)
                ) {
                  if (void 0 === n[e])
      ...
      return (
        (t.fn[i] = _._jQueryInterface),
        (t.fn[i].Constructor = _),
        (t.fn[i].noConflict = function () {
          return (t.fn[i] = c), _._jQueryInterface;
        }),
        _
      );
    })(t);
