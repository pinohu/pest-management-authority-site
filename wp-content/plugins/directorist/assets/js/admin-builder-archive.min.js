  ...
  var e = {
      ...
      3886: function (e, t, r) {
        window.addEventListener("load", function () {
          var e = jQuery,
            t = r(2505).default;
          e(".atbdp-directory-migration-link").on("click", function (r) {
            r.preventDefault();
            var n = this;
            e(".cptm-directory-migration-form")
              .find(".cptm-comfirmation-text")
              .html("Please wait..."),
              e(".atbdp-directory-migration-cencel-link").remove(),
              e(this).html(
        ...
        e.exports = function (e) {
          return new Promise(function (t, r) {
            ...
            if (
              ...
              (m.onabort = function () {
                m &&
                  (r(l("Request aborted", e, "ECONNABORTED", m)), (m = null));
              }),
              (m.onerror = function () {
        ...
        window.addEventListener("load", function () {
          ...
          t(".cptm-import-directory-form").on("submit", function (r) {
            ...
            var o = t(this).find(".cptm-form-group-feedback"),
              a = t(".cptm-import-directory-modal").find(".cptm-modal-content"),
            ...
            c.append("action", "save_imported_post_type_data"),
              ...
              Number.isInteger(i) && i > 0 && c.append("term_id", i);
            ...
            try {
              for (p.s(); !(u = p.n()).done; ) {
                var f = u.value;
                f.name.length &&
                  (l.includes(f.type) && c.append(f.name, t(f).val()),
                  "file" === f.type && c.append(f.name, f.files[0]));
              }
            } catch (e) {
              p.e(e);
            } finally {
      ...
      9791: function () {
        window.addEventListener("load", function () {
          var e = jQuery;
          e(".atbdp-directory-delete-link-action").on("click", function (t) {
            t.preventDefault();
            var r = e(this).data("delete-link");
            e(".atbdp-directory-delete-link").prop("href", r);
          }),
            e(".atbdp-directory-delete-link").on("click", function (t) {
              e(this).prepend('<i class="fas fa-circle-notch fa-spin"></i> '),
                e(".atbdp-directory-delete-cancel-link").removeClass(
                  "cptm-modal-toggle",
                ),
                e(".atbdp-directory-delete-cancel-link").addClass(
                  "atbdp-disabled",
                );
            });
        });
  ...
  (r.n = function (e) {
    ...
    (function () {
      ...
      var e = jQuery,
        t = r(2505).default;
      window.addEventListener("load", function () {
        e(".directorist_directory_template_library").on("click", function (r) {
          r.preventDefault();
          var n = this;
          e(n)
          ...
          var i = new FormData();
          i.append("action", "directorist_directory_type_library"),
            i.append("directorist_nonce", directorist_admin.directorist_nonce);
          var o = function (t) {
            var r, i;
            e(n)
              .siblings(".cptm-create-directory-modal__action__single")
          ...
          e(".directorist-ai-directory-creation").on("click", function (r) {
            r.preventDefault();
            var n = new FormData();
      ...
      function v(t) {
        ...
        var r = document.querySelector(".directory-generate-btn__wrapper"),
          n = document.querySelector(".directory-generate-btn__percentage"),
              ...
              d.forEach(function (t, r) {
                ...
                e >= n
                  ? (t.setAttribute("data-type", "completed"),
                    (t.querySelector(".completed-icon").style.display =
                      "block"),
                    (t.querySelector(".progress-icon").style.display = "none"),
                    (t.querySelector(".default-icon").style.display = "none"))
                  : e < n && e >= n - 100 / d.length
                    ? (t.setAttribute("data-type", "progress"),
                      (t.querySelector(".completed-icon").style.display =
                        "none"),
                      (t.querySelector(".progress-icon").style.display =
                        "block"),
                      (t.querySelector(".default-icon").style.display = "none"))
                    : (t.setAttribute("data-type", "default"),
                      (t.querySelector(".completed-icon").style.display =
                        "none"),
                      (t.querySelector(".progress-icon").style.display =
                        "none"),
                      (t.querySelector(".default-icon").style.display =
                        "block"));
              });
          };
      }
      ...
      function C() {
        e("#directorist-create-directory__creating").hide(),
          ...
          e(".directorist-create-directory__back__btn").addClass("disabled"),
          e(
            '.directorist-create-directory__content__items[data-step="1"]',
          ).show(),
          e(".directorist-create-directory__step .step-count .total-step").html(
            n,
          ),
          e(
        ...
        function i(t) {
          y(),
            "" === t
              ...
              : (g(), e("#new-directory-type").removeClass("empty"));
        }
        t.val() || (_(), (o = "")),
          r.val() || (a = ""),
          ...
          e("body").on("input keyup", "#directorist-ai-prompt", function (t) {
            e("#directorist-ai-prompt")
              .siblings(".character-count")
              .find(".current-count")
              .text(c.length),
              t.target.value.length > d
                ? ((t.target.value = t.target.value.substring(0, d)),
                  e(t.target).addClass("max-char-reached"))
                : e(t.target).removeClass("max-char-reached"),
              t.target.value ? ((c = t.target.value), g()) : ((c = ""), _());
          }),
          e('[name="directory_type[]"]').each(function () {
            e(this).is(":checked") && (s = e(this).val());
          }),
          e("body").on("change", '[name="directory_type[]"]', function (t) {
            "others" === (s = t.target.value)
              ? ((s = e("#new-directory-type").val()),
                e("#directorist-create-directory__checkbox__others").show(),
                i(s),
              ...
              : (e("#directorist-create-directory__checkbox__others").hide(),
                y());
          });
      }
      function b(t) {
        ...
        e(
          ...
          (a = document.getElementById("directorist-recommendedTags")),
          ...
          (p = function () {
            (n.innerHTML = r
              ...
              .join("")),
              n.appendChild(
                o.parentNode || document.createElement("li").appendChild(o),
              ),
              s.forEach(function (e) {
                var t = e.textContent.trim();
                e.classList.toggle("disabled", r.includes(t));
              }),
              (d.textContent = "".concat(r.length, "/").concat(5)),
          ...
          n.addEventListener("click", function (e) {
            ...
            e.target.classList.contains("directorist-rmTag") &&
              -1 !==
                (t = Array.from(n.children).indexOf(e.target.parentElement)) &&
              (r.splice(t, 1), p());
          }),
          ...
          p(),
          m("Select relevant keywords to <br /> optimize AI-generated content"),
      ...
      function w(t) {
        ...
        e("#directorist-create-directory__ai-fields").show(),
          ...
          e(".directorist-create-directory__content").removeClass("full-width"),
          ...
          (n = document.querySelectorAll(".directorist-ai-generate-dropdown")),
          e("#directorist-create-directory__ai-fields .fields-count").html(
            n.length,
          ),
          n.forEach(function (e) {
            var t = e.querySelector(
              ...
              r = e.querySelector(".directorist-ai-generate-dropdown__content"),
              i = e.querySelector(
            ...
            o.addEventListener("click", function (e) {
              ...
              t &&
                t.addEventListener("click", function (t) {
                  if (t.target !== o && !o.contains(t.target)) {
                    var a =
                      r &&
                      r.classList.toggle(
      ...
      e("body").on(
        ...
        e("body").on(
          ...
          function (r) {
            if ((r.preventDefault(), 1 == i))
              return (
                e(".directorist-create-directory__back__btn").removeClass(
                  "disabled",
                ),
                e(
                  '.directorist-create-directory__content__items[data-step="1"]',
            ...
            3 == i
              ? (e("#directorist-create-directory__generating").show(),
                e(".directorist-create-directory__top").hide(),
                e(".directorist-create-directory__content__items").hide(),
                e(".directorist-create-directory__header").hide(),
                e(".directorist-create-directory__content__footer").hide(),
                e(".directorist-create-directory__content").toggleClass(
                  "full-width",
                ),
                h("Build Directory"),
                v())
              : 4 == i &&
                (e("#directorist-create-directory__generating").show(),
                e("#directorist-create-directory__creating").show(),
                e("#directorist-create-directory__ai-fields").hide(),
                ...
                e(".directorist-create-directory__header").hide(),
                e(".directorist-create-directory__content__footer").hide(),
                e(".directorist-create-directory__content").addClass(
                  "full-width",
                ),
                e("#directorist-create-directory__preview-btn").addClass(
                  "disabled",
                ),
                e(
                ...
                .then(function (t) {
                  g(),
                    (function (t) {
                      ...
                      } else console.error(null == t ? void 0 : t.data);
                    })(t);
                })
                .catch(function (e) {
                  var t, r;
        ...
        e("body").on("click", ".directorist_regenerate_fields", function (r) {
          var n = this;
            ...
            t
              ...
              .then(function (t) {
                ...
                e(n).removeClass("loading"),
                  ...
                  e(".directorist_regenerate_fields").hide(),
                  (u = JSON.stringify(t.data.data.fields));
              })
              .catch(function (t) {
                var r, i;
                !1 ===
                  (null === (r = t.response.data) || void 0 === r
                    ? void 0
                    : r.success) &&
                  "limit_exceeded" ===
