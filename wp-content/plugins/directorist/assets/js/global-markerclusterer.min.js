!(function () {
  ...
  function e(t, r, o) {
    ...
    google.maps.event.addListener(this.map_, "zoom_changed", function () {
      ...
      r && r.length && this.addMarkers(r, !1);
  }
  function r(t) {
  ...
  (e.prototype.MARKER_CLUSTER_IMAGE_PATH_ =
    "http://google-maps-utility-library-v3.googlecode.com/svn/trunk/markerclusterer/images/m"),
    (e.prototype.MARKER_CLUSTER_IMAGE_EXTENSION_ = "png"),
    ...
    (e.prototype.fitMapToMarkers = function () {
      for (
        var t, e = this.getMarkers(), r = new google.maps.LatLngBounds(), o = 0;
        (t = e[o]);
        o++
      )
    ...
    (e.prototype.calculator_ = function (t, e) {
      for (var r = 0, o = t.length, s = o; 0 !== s; )
        (s = parseInt(s / 10, 10)), r++;
      return { text: o, index: (r = Math.min(r, e)) };
    }),
    ...
    (e.prototype.addMarkers = function (t, e) {
      for (var r, o = 0; (r = t[o]); o++) this.pushMarkerTo_(r);
      e || this.redraw();
    }),
    ...
    (e.prototype.removeMarkers = function (t, e) {
      for (var r, o = !1, s = 0; (r = t[s]); s++) {
        var i = this.removeMarker_(r);
        o = o || i;
      }
      if (!e && o) return this.resetViewport(), this.redraw(), !0;
    }),
    ...
    (e.prototype.resetViewport = function (t) {
      ...
      var o;
      for (r = 0; (o = this.markers_[r]); r++)
        (o.isAdded = !1), t && o.setMap(null);
      this.clusters_ = [];
    }),
    ...
    (e.prototype.addToClosestCluster_ = function (t) {
      for (
        var e, o = 4e4, s = null, i = (t.getPosition(), 0);
        (e = this.clusters_[i]);
        i++
      ) {
        var n = e.getCenter();
      ...
      s && s.isMarkerInClusterBounds(t)
        ? s.addMarker(t)
        : ((e = new r(this)).addMarker(t), this.clusters_.push(e));
    }),
    (e.prototype.createClusters_ = function () {
      if (this.ready_)
        for (
          ...
          !t.isAdded &&
            this.isMarkerInBounds_(t, r) &&
            this.addToClosestCluster_(t);
    }),
    (r.prototype.isMarkerAlreadyAdded = function (t) {
    ...
    (r.prototype.addMarker = function (t) {
      ...
      if (this.center_) {
        if (this.averageCenter_) {
          var e = this.markers_.length + 1,
            ...
            o = (this.center_.lng() * (e - 1) + t.getPosition().lng()) / e;
          (this.center_ = new google.maps.LatLng(r, o)),
      ...
      if (
        ...
        for (var i = 0; i < s; i++) this.markers_[i].setMap(null);
    ...
    (r.prototype.updateIcon = function () {
      ...
      if (e && t > e)
        ...
        var s = this.markerClusterer_.getStyles().length,
          i = this.markerClusterer_.getCalculator()(this.markers_, s);
    ...
    (o.prototype.onAdd = function () {
      if (((this.div_ = document.createElement("DIV")), this.visible_)) {
        ...
        e.cssClass_ && (this.div_.className = e.cssClass_);
      }
    ...
    (o.prototype.createCss = function (e) {
      ...
      if (this.cluster_.getMarkerClusterer().cssClass_)
        r.push("top:" + e.y + "px; left:" + e.x + "px;");
      else {
        r.push("background-image:url(" + this.url_ + ");");
        var o = this.backgroundPosition_ ? this.backgroundPosition_ : "0 0";
        r.push("background-position:" + o + ";"),
          "object" === t(this.anchor_)
            ? ("number" == typeof this.anchor_[0] &&
              ...
              this.anchor_[1] < this.width_
                ...
                : r.push("width:" + this.width_ + "px; text-align:center;"))
            : r.push(
                "height:" +
                  this.height_ +
                  "px; line-height:" +
    ...
    (window.MarkerClusterer = e),
    (e.prototype.addMarker = e.prototype.addMarker),
    (e.prototype.addMarkers = e.prototype.addMarkers),
    (e.prototype.clearMarkers = e.prototype.clearMarkers),
    (e.prototype.fitMapToMarkers = e.prototype.fitMapToMarkers),
    (e.prototype.getCalculator = e.prototype.getCalculator),
    (e.prototype.getGridSize = e.prototype.getGridSize),
    (e.prototype.getExtendedBounds = e.prototype.getExtendedBounds),
    (e.prototype.getMap = e.prototype.getMap),
    (e.prototype.getMarkers = e.prototype.getMarkers),
    (e.prototype.getMaxZoom = e.prototype.getMaxZoom),
    (e.prototype.getStyles = e.prototype.getStyles),
    (e.prototype.getTotalClusters = e.prototype.getTotalClusters),
    (e.prototype.getTotalMarkers = e.prototype.getTotalMarkers),
    (e.prototype.redraw = e.prototype.redraw),
    (e.prototype.removeMarker = e.prototype.removeMarker),
    (e.prototype.removeMarkers = e.prototype.removeMarkers),
    (e.prototype.resetViewport = e.prototype.resetViewport),
    (e.prototype.repaint = e.prototype.repaint),
    (e.prototype.setCalculator = e.prototype.setCalculator),
    (e.prototype.setGridSize = e.prototype.setGridSize),
    (e.prototype.setMaxZoom = e.prototype.setMaxZoom),
