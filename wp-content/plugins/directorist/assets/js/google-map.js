/******/ (function () {
      ...
      /***/ function (
        ...
        function initAddListingMap() {
          ...
          if ($("#gmap").length) {
            ...
            _lib_helper__WEBPACK_IMPORTED_MODULE_0__.get_dom_data)("map_data");
  ...
  \******************************************************/
    ...
    (function () {
      ...
      function initMap() {
        var mapData = (0,
        _lib_helper__WEBPACK_IMPORTED_MODULE_0__.get_dom_data)("atbdp_map");
        ...
        (function ($) {
          ...
          function atbdp_add_marker($marker, map, infowindow) {
            ...
            var marker = new Marker({
              ...
              map_icon_label:
                icon !== undefined &&
                '<div class="atbd_map_shape">'.concat(icon, "</div>"),
            });
          ...
          function setup_info_window() {
            ...
            abc.forEach(function (el, index) {
              if (el.innerText === "atgm_marker") {
                el.innerText = " ";
                el.innerHTML = '<i class="atbd_map_marker_icon">'.concat(
                  at_icon,
                  "</i>",
                );
              }
