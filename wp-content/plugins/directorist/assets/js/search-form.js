    ...
    ------------------ */
        ...
        function initSearchFields() {
          ...
          searchFields.forEach(function (searchField) {
            ...
            if (inputFieldValue !== "") {
              ...
              inputFieldValue = "";
              if (
                searchField.parentElement.classList.contains("input-has-value")
              ) {
        ...
        $("body").on(
          ...
          function (e) {
            ...
            var checkboxFields = this.parentElement.querySelectorAll(
              'input[type="checkbox"]',
            );
            if (selectboxField) {
            ...
            if (
              ...
              (_this$parentElement$q = this.parentElement.querySelector(
                ".directorist-search-basic-dropdown-content.dropdown-content-show",
              )) === null ||
                _this$parentElement$q === void 0 ||
                _this$parentElement$q.classList.remove("dropdown-content-show");
            }
            handleRadiusVisibility();
        ...
        function init_map_api_field() {
          if (directorist.i18n_text.select_listing_map === "google") {
                ...
                input.forEach(function (elm) {
                  ...
                  google.maps.event.addListener(
                    ...
                    function () {
                      ...
                      elm
                        .closest(".directorist-search-field")
                        .querySelector("#".concat(field.lat_id)).value =
                        place.geometry.location.lat();
                      elm
                        .closest(".directorist-search-field")
                        .querySelector("#".concat(field.lng_id)).value =
            ...
            var getWidgetResultContainer = function getWidgetResultContainer(
              context,
              field,
            ) {
              ...
              $(field.input_elm).on(
                ...
                _global_components_debounce__WEBPACK_IMPORTED_MODULE_0__[
                  ...
                  var blockedKeyCodes = [
                    ...
                    91, 93, 112, 113, 114, 115, 116, 117, 118, 119, 120, 121,
                    122, 123, 144, 145,
                  ];
        ...
        function directorist_custom_range_slider() {
          ...
          sliders.forEach(function (sliderItem) {
            ...
            var milesParams = new URLSearchParams(window.location.search).has(
              "miles",
            );
            var customParams = new URLSearchParams(window.location.search).has(
              "miles",
            );
            (_directoristCustomRan = directoristCustomRangeSlider) === null ||
            ...
            (_slider$directoristCu = slider.directoristCustomRangeSlider) ===
              null ||
              _slider$directoristCu === void 0 ||
              _slider$directoristCu.on("update", function (values, handle) {
        ...
        $("body").on(
          ...
          directorist_debounce(function () {
            ...
            if (directorist.i18n_text.select_listing_map === "google") {
              ...
              url = "https://nominatim.openstreetmap.org/?postalcode=".concat(
                zipcode,
                  ...
                  if (data.length === 1) {
                    ...
                    for (var i = 0; i < data.length; i++) {
                      res += '<li><a href="#" data-lat='
                        ...
                        .concat(data[i].lon, ">")
                        .concat(data[i].address.country, "</a></li>");
                    }
                  }
