        ...
        (function ($) {
          window.addEventListener("load", function () {
            ...
            $(".directorist-become-author-modal__cancel").on(
              ...
              function (e) {
                e.preventDefault();
                $(".directorist-become-author-modal").removeClass(
                  "directorist-become-author-modal__show",
                );
              },
            );
            ...
            $("#user_preferences").on("submit", function (e) {
              ...
              $.ajax({
                ...
                success: function success(response) {
                  ...
                  if (response.success) {
                    $("#directorist-preference-notice").html(
              ...
              try {
                for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                  ...
                  if (
                    ...
                    if (parent) {
                      var dropdownMenu = parent.querySelector(
                        ".atbd-dashboard-nav",
                      );
                      if (dropdownMenu) {
                ...
                links.forEach(function (link) {
                  ...
                  link.addEventListener("click", function (event) {
                    ...
                    if (parentNavRef) {
                      ...
                      var dropDownToggler =
                        (_event$target$closest = event.target.closest(
                          ".atbdp_tab_nav--has-child",
                        )) === null || _event$target$closest === void 0
                          ? void 0
                    ...
                    var hasMatch = window.location.hash.match(
                      new RegExp("^".concat(link, "$")),
                    );
