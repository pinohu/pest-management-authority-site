        ...
        (function ($) {
          window.addEventListener("load", function () {
            ...
            if ($(".directorist-authors__nav").length) {
              $(".directorist-authors__nav ul li:first-child").addClass(
                "active",
              );
            }
            /* authors nav item */
            ...
            $("body").on(
              ...
              function (e) {
                ...
                if ($(this).hasClass("prev")) {
                  paged =
                    parseInt(
                      $(".directorist-authors-pagination .current").text(),
                    ) - 1;
                }
                ...
                $.ajax({
                  ...
                  success: function success(response) {
                    ...
                    authorsMasonry();
                    if (
                      document.querySelector("." + getAlphabetValue) !== null
                    ) {
                      document
                        .querySelector("." + getAlphabetValue)
                        .closest("li")
