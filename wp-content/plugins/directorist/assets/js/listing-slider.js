    ...
    function allListingSlider() {
      ...
      singleListingSlider.forEach(function (el, i) {
        ...
        var updateBlurredBackground = function updateBlurredBackground() {
          ...
          var blurredBackground = swiperCarouselSingleListing.querySelector(
            ".blurred-background",
          );
          ...
          var activeSlide = swiperCarouselSingleListing.querySelector(
          ...
          if (activeSlide) {
            ...
            blurredBackground.style.backgroundImage = "url(".concat(
              activeImageSrc,
              ")",
        ...
        var sliderItemsCount = swiperCarouselSingleListing.querySelectorAll(
        ...
        if (swiperCarouselSingleListing) {
          ...
          if (dataBackgroundSize === "contain") {
            swiperCarouselSingleListing.style.backgroundColor =
              dataBackgroundColor ? dataBackgroundColor : "transparent";
        ...
        if (swiperCarouselSingleListingThumb) {
          ...
          swiperCarouselSingleListingThumb.style.backgroundColor =
            dataThumbnailsBackground ? dataThumbnailsBackground : "transparent";
        }
      });
    }
