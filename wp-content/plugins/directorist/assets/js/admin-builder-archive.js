      ...
      /***/ function (
        ...
        window.addEventListener("load", function () {
          ...
          $(".atbdp-directory-migration-link").on("click", function (e) {
            ...
            var responseSuccessCallback = function responseSuccessCallback(
              response,
            ) {
              var _response$data;
            ...
            var responseFaildCallback = function responseFaildCallback(
              response,
            ) {
      ...
      /***/ function (
        ...
        window.addEventListener("load", function () {
          ...
          $(".cptm-import-directory-form").on("submit", function (e) {
            ...
            var modal_content = $(".cptm-import-directory-modal").find(
              ".cptm-modal-content",
            );
  ...
  \********************************************************/
    ...
    function updatePrompt() {
      directoryPrompt = "I want to create a "
        ...
        .concat(directoryLocation ? " in ".concat(directoryLocation) : "");
            ...
            if (accordion) {
              dropdowns.forEach(function (otherDropdown) {
                if (otherDropdown !== dropdown) {
                  var otherContent = otherDropdown.querySelector(
                    ".directorist-ai-generate-dropdown__content",
                  );
    ...
    $("body").on("click", ".directorist_generate_ai_directory", function (e) {
      ...
      axios
        ...
        .catch(function (error) {
          ...
          if (
            ((_error$response$data = error.response.data) === null ||
            _error$response$data === void 0
              ? void 0
              : _error$response$data.success) === false &&
            ((_error$response$data2 = error.response.data) === null ||
            _error$response$data2 === void 0 ||
            (_error$response$data2 = _error$response$data2.data) === null ||
            _error$response$data2 === void 0
              ? void 0
              : _error$response$data2.code) === "limit_exceeded"
          ) {
    ...
    $("body").on("click", ".directorist_regenerate_fields", function (e) {
      ...
      axios
        ...
        .then(function (response) {
          ...
          handleGenerateFields(
            response === null ||
              ...
              (_response$data10 = _response$data10.data) === null ||
              _response$data10 === void 0
              ? void 0
        ...
        .catch(function (error) {
          ...
          if (
            ((_error$response$data3 = error.response.data) === null ||
            _error$response$data3 === void 0
              ? void 0
              : _error$response$data3.success) === false &&
            ((_error$response$data4 = error.response.data) === null ||
            _error$response$data4 === void 0 ||
            (_error$response$data4 = _error$response$data4.data) === null ||
            _error$response$data4 === void 0
              ? void 0
