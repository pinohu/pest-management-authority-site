/******/ (function () {
  ...
  \*********************************/
      /***/ function (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ directoristRequestHeaders: function () {
  ...
  \*********************************************/
    ...
    function scrollTo(selector) {
      ...
      (_document$querySelect = document.querySelector(selector)) === null ||
    ...
    $(function () {
      ...
      function renderCategoryCustomFields() {
        ...
        for (
          var _i = 0, _Object$entries = Object.entries(fieldsMap[directoryId]);
                  ...
                  $notification
                    ...
                    .html(
                      '<span class="atbdp_success">'.concat(
                        localized_data.i18n_text.image_uploading_msg,
                        "</span>",
                      ),
                    );
                } else {
                ...
                uploader.media_uploader
                  ...
                  .forEach(function (file_meta) {
                    if (file_meta.attachmentID) {
                      form_data.append(
                        "".concat(uploader.uploaders_data.meta_name, "_old[]"),
          ...
          $.ajax({
            ...
            success: function success(response) {
              ...
              if (response.error === true) {
                ...
                $notification
                  .show()
                  .html("<span>".concat(response.error_msg, "</span>"));
                ...
                if (
                  ...
                  if (response.edited_listing !== true) {
                    ...
                    if (qs.redirect) {
                      ...
                      window.location.href = joinQueryString(
                        response.preview_url,
                        "preview=1&edited=1&redirect=".concat(redirect_url),
                      );
                    }
                  }
                  ...
                  window.location.href = joinQueryString(
                    response.preview_url,
                    "preview=1&payment=1&redirect=".concat(redirect_url),
                  );
                } else {
      ...
      function addSticky() {
        $(window).scroll(
          (0, _components_debounce__WEBPACK_IMPORTED_MODULE_7__["default"])(
            function () {
