            ...
            $.ajax({
              ...
              success: function success(response) {
                ...
                var updatedCategoryContent =
                  (_tempContainer$queryS = tempContainer.querySelector(
                    ".taxonomy-category-wrapper",
                  )) === null || _tempContainer$queryS === void 0
                    ? void 0
                    : _tempContainer$queryS.innerHTML;
                var updatedLocationContent =
                  (_tempContainer$queryS2 = tempContainer.querySelector(
                    ".taxonomy-location-wrapper",
                  )) === null || _tempContainer$queryS2 === void 0
                    ? void 0
      ...
      /***/ function () {
        (function ($) {
          ...
          function atbdp_do_ajax(
            ...
            if (n < 0) {
              data =
                data + "&" + directorist.nonceName + "=" + directorist.nonce;
            }
            jQuery.ajax({
              type: "post",
        ...
        (function ($) {
          ...
          function update_instant_search_url(form_data) {
            if (history.pushState) {
              ...
              if (
                ...
                var query =
                  query && query.length
                    ? query + "&search_by_rating=" + form_data.search_by_rating
              ...
              if (
                ...
                Object.keys(form_data.custom_field).forEach(function (key) {
                  query = query.length
                    ? query +
                      "&".concat(key, "=").concat(form_data.custom_field[key])
                    : "?".concat(key, "=").concat(form_data.custom_field[key]);
                });
              }
          ...
          $("body").on(
            ...
            function (e) {
              ...
              var customFieldsAreEmpty = Object.values(data.custom_field).every(
                function (item) {
                  return !item;
                },
              );
              ...
              $.ajax({
                ...
                beforeSend: function beforeSend() {
                  ...
                  instant_search_element
                    .find(".directorist-dropdown__links")
                    .hide();
                  var advance_filter = instant_search_element.find(
                    ".directorist-header-bar .directorist-advanced-filter",
                  )[0];
            ...
            activeForm.find('[name^="custom_field"]').each(function (_, el) {
              ...
              if (type === "radio") {
                customField[postId] = activeForm
                  .find(
                    "input[name='custom_field[".concat(postId, "]']:checked"),
                  )
                  .val();
          ...
          if ($(".directorist-instant-search").length === 0) {
            $("body").on(
              ...
              function (e) {
                ...
                var action_value = $(".directorist-advanced-search").attr(
                  "action",
                );
        ...
        function initMasonry() {
          ...
          function authorsMasonry(selector) {
            ...
            $(authorsCard).each(function (id, elm) {
              ...
              var authorMasonryInit = $(authorsCardRow).imagesLoaded(
                function () {
                    ...
                    try {
                      for (_iterator.s(); !(_step = _iterator.n()).done; ) {
                        ...
                        if (mutation.removedNodes) {
                          ...
                          try {
                            for (
                              ...
                              var criteria = node.querySelector(
                                ".directorist-review-criteria",
                              );
                              if (criteria) {
                                criteria.style.display = "";
                              }
                              var ratings = node.querySelectorAll(
                                ".directorist-review-criteria-select",
                              );
                              var _iterator3 =
                                  _createForOfIteratorHelper(ratings),
                                _step3;
                              try {
                                for (
                                  _iterator3.s();
                        ...
                        if (form) {
                          ...
                          var isEditing = target.classList.contains(
                            "directorist-form-editing",
                          );
                          if (!isReview || (isReview && !isEditing)) {
                            var _criteria = form.querySelector(
                              ".directorist-review-criteria",
                            );
                            if (_criteria) {
                              _criteria.style.display = "none";
                            }
                            var _ratings = form.querySelectorAll(
                              ".directorist-review-criteria-select",
                            );
                            var _iterator4 =
                                _createForOfIteratorHelper(_ratings),
                              _step4;
                            try {
                              for (
                                _iterator4.s();
                  ...
                  },
                  {
                    ...
                    value: function onSubmit(event) {
                      ...
                      updateComment.done(function (data, status, request) {
                        ...
                        var commentTop = $("#comment-" + commentID).offset()
                          .top;
      ...
      /***/ function (
        ...
        jQuery(function ($) {
          ...
          var updateMarkup = function updateMarkup(viewCounts) {
            for (
              var _i = 0, _Object$entries = Object.entries(viewCounts);
          ...
          var cache =
            ...
            _window$localStorage === void 0
              ? void 0
              : _window$localStorage.getItem("directorist_view_count");
          var hasCache = false;
          if (cache) {
            var _cache, _cache2;
